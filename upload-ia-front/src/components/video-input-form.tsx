...
export function VideoInputForm (props:VideoInputFormProps){
    ...
    return(
        <form onSubmit={handleUploadVideo} className="space-y-6">
            ...
            previewURL 
            ?  
                <video src={previewURL} controls={false} className="pointer-events-none absolute inset-0 w-full h-full object-cover"></video>
            :
                <>
            ...
            <Button 
                ...
                disabled={status !== 'waiting'} 
                type="submit" 
                className="gap-2 w-full data-[success=true]:bg-emerald-400">
                {
                    status === 'waiting'
                    ?
                    <>
